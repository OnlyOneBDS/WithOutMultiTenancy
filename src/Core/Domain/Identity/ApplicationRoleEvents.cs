namespace WithOutMultiTenancy.Domain.Identity;
...
public class ApplicationRoleUpdatedEvent : ApplicationRoleEvent
{
  ...
  public ApplicationRoleUpdatedEvent(string roleId, string roleName, bool permissionsUpdated = false) : base(roleId, roleName)
  {
...
public class ApplicationRoleDeletedEvent : ApplicationRoleEvent
{
  ...
  public ApplicationRoleDeletedEvent(string roleId, string roleName) : base(roleId, roleName) { }
}