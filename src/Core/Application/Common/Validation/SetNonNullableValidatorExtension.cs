...
namespace WithOutMultiTenancy.Application.Common.Validation;
...
public static class SetNonNullableValidatorExtension
{
  ...
  {
    public NullableChildValidatorAdaptor(IValidator<TProperty> validator, Type validatorType) : base(validator, validatorType) { }
