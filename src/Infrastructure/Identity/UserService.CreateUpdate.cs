...
using WithOutMultiTenancy.Domain.Common;
...
internal partial class UserService
{
  ...
  public async Task<string> CreateAsync(CreateUserRequest request, string origin)
  {
    ...
    if (_securitySettings.RequireConfirmedAccount && !string.IsNullOrEmpty(user.Email))
    {
      ...
      var mailRequest = new MailRequest(new List<string> { user.Email }, _localizer["Confirm Registration"], _templateService.GenerateEmailTemplate("email-confirmation", eMailModel));
