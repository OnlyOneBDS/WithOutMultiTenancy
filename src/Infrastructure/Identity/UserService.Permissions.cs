...
internal partial class UserService
{
  ...
  {
    var permissions = await _cache.GetOrSetAsync(_cacheKeys.GetCacheKey(FSHClaims.Permission, userId), () => GetPermissionsAsync(userId, cancellationToken), cancellationToken: cancellationToken);
